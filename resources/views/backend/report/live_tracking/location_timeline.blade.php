                                    ...
                                    @if (isset($_GET['location_pattern']) && isset($_GET['user']) && isset($_GET['date']))
                                        @foreach ($data['timeline'] as $key => $timeline)
                                            <div class="step active">
                                                ...
                                                <p class="text-left mt-3">{{ @$timeline->created_at->format('H:i:s A') }}</p>
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-xl-3 d-none">
                                                    <div class="form-group">
                                                        <select name="location_pattern"
                                                                class="form-control select2 mb-3"
                                                                onchange="submitForm()">
                                                            <option value="3"
                                                                    @if (@$_GET['location_pattern']==3) selected @else
                                                                    selected @endif>
                            ...
                            <div class="col-lg-12">
                                <ol>
                                    <li>Go to the <a href="https://console.cloud.google.com/" target="_blank"
                                                     class="text-info">Google Cloud Console</a>.
                                    </li>
                                    ...
                                    <li>Enter a name for your project, select an organization (if applicable), and
                                        choose a
                                ...
                                <ol>
                                    <li>In the GCP Console, navigate to the "APIs &amp; Services" &gt; "Library"
                                        section.
                                    </li>
                                ...
                                <ol>
                                    ...
                                    <li>Your API key will be displayed on the next screen. Make sure to restrict the
                                        usage
                                        of
...
@section('script')
    ...
    {{--        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAkIZY-QSVxT_UQBZStOMM4havyONaOZIc"></script>--}}
    <script>
        function submitForm() {
