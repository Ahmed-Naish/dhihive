            ...
            <form method="POST" action="{{ route('user.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                                ...
                                <select name="country" class="form-control ot-form-control ot-input select2"
                                    ...
                                    @foreach ($data["countries"] as $country)
                                        <option value="{{ $country->id }}"
                                            {{ $country->name === 'Maldives' ? 'selected' : '' }}>
                                            {{ $country->name }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label class="form-label mt-3">{{ _trans('common.Attendance Method') }} <span class="text-danger">*</span></label>
                                <select name="attendance_method[]" class="form-control " id="attendance_method" multiple>
                                    <option value="normal_attendance" selected>{{ _trans('common.Normal Attendance') }}</option> 
                                </select>
