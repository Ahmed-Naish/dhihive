...
class SupportTicketRepository
{
    ...
    public function ticketList($request): \Illuminate\Http\JsonResponse
    {
        ...
        $tickets = $tickets->whereMonth('created_at', $month);
    ...
    function table($request){
        ...
        return [
            'data' => $data->map(function ($data) {
                $action_button = '';
                if (hasPermission('support_reply')) {
                    $action_button .= '<a href="' . route('supportTicket.reply', [$data->id, encrypt($data->code)]) . '" class="dropdown-item">' . _trans('common.Reply') . '</a>';
                }
