...
class AppSettingsRepository
{
    ...
    {
        date_default_timezone_set(auth()->user()->country->time_zone??'Indian/Maldives');
        ...
        $data['time_zone'] = auth()->user()->country->time_zone??'Indian/Maldives';
        ...
        $data['break_status'] = isModuleActive('Break') ? resolve(EmployeeBreakService::class)->isBreakRunning() : null;
        ...
        $data['notification_channels'] = auth()->user()->notification_subscribe_channel();
...
//    }
    ...
    {
        $data = Cache::remember('branding_data', 60 * 60, function () {
            return Branding::pluck('value', 'name');
        });
