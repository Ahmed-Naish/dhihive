...
class SalaryRepository
{
    ...
    public function generate($request)
    {
        ...
        try {
            ...
            $salary = $this->model->where('company_id', auth()->user()->company_id)->whereMonth('date', date('m', strtotime($request->month)))->whereYear('date', date('Y', strtotime($request->month)))->whereIn('user_id', $users)->get();
            if (!blank($salary)) {
