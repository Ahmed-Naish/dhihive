        ...
        try {
            ...
            if (@$request->user_ids) {
                foreach ($request->user_ids as $user_id) {
                    ...
                    $params['message'] = "<b class='text-dark'>" . $member_info->name . ' [' . $member_info->employee_id . "]</b> have been assigned the task <b class='text-dark'>[" . $task->name . "]</b> with a priority level of <b class='text-warning'>[" . $task->priorityStatus->name . "].</b>";
                    ...
                    $params['redirectUrlForWeb'] = route('task.view', [$task->id, 'details']);
