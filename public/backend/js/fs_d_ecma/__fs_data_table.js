...
function attendanceDatatable(...values) {
  ...
  if (selfieBasedAttendanceActive) {
    var checkInIndex = data["column"].indexOf("checkin");
    if (checkInIndex !== -1) {
        data["column"].splice(checkInIndex + 1, 0, "checkInImage");
    }
    var checkOutIndex = data["column"].indexOf("checkout");
    if (checkOutIndex !== -1) {
        data["column"].splice(checkOutIndex + 1, 0, "checkOutImage");
    }
    //data["column"].push("checkInImage", "checkOutImage");
  }
  // console.log(data);
...
$("#goal_type_table_url").length > 0 && performanceSettingsTable("goal_type_table_url");
...
//contact_message_table start
function contactMessageDatatable(...values) {
  let data = [];
  let url = tableUrl + "/admin/saas/contact-messages";
  data["url"] = url;
  ...
  data["table_id"] = "contact_message_datatable";
  table(data);
}
$(".contact_message_datatable").length > 0 ? contactMessageDatatable() : "";
//contact_message_table end


//subscriber_table start
function subscriberDatatable(...values) {
  let data = [];
  let url = tableUrl + "/admin/saas/subscribers";
  data["url"] = url;
  ...
  data["table_id"] = "subscriber_datatable";
  table(data);
}
$(".subscriber_datatable").length > 0 ? subscriberDatatable() : "";
//subscriber_table end



//travel_plan_datatable start
function travelPlanDatatable(...values) {
  let data = [];
  data["url"] = $("#travel_plan_datatable_url").val();
  let { from, to } = __date_range ?? {};
  var shortBy = $("#short_by").val();
  data["value"] = {
    from: from ? from : null,
  ...
  data["table_id"] = "travel_plan_datatable";
  table(data);
}
$(".travel_plan_datatable").length > 0 ? travelPlanDatatable() : "";
//travel_plan_datatable end



//travel_plan_meeting_datatable start
function travelPlanMeetingDatatable(...values) {
  let data = [];
  data["url"] = $("#travel_plan_meeting_datatable_url").val();
  let { from, to } = __date_range ?? {};
  var shortBy = $("#short_by").val();
  data["value"] = {
    from: from ? from : null,
  ...
  data["table_id"] = "travel_plan_meeting_datatable";
  table(data);
}
$(".travel_plan_meeting_datatable").length > 0 ? travelPlanMeetingDatatable() : "";
//travel_plan_meeting_datatable end



//travel_plan_expense_datatable start
function travelPlanExpenseDatatable(...values) {
  let data = [];
  data["url"] = $("#travel_plan_expense_datatable_url").val();
  let { from, to } = __date_range ?? {};
  var shortBy = $("#short_by").val();
  data["value"] = {
    from: from ? from : null,
  ...
  data["table_id"] = "travel_plan_expense_datatable";
  table(data);
}
$(".travel_plan_expense_datatable").length > 0 ? travelPlanExpenseDatatable() : "";
//travel_plan_expense_datatable end


//travel_workflow_datatable start
function travelWorkflowDatatable(...values) {
  let data = [];
  data["url"] = $("#travel_workflow_datatable_url").val();
  let { from, to } = __date_range ?? {};
  var shortBy = $("#short_by").val();
  data["value"] = {
    from: from ? from : null,
  ...
  data["table_id"] = "travel_workflow_datatable";
  table(data);
}
$(".travel_workflow_datatable").length > 0 ? travelWorkflowDatatable() : "";
//travel_workflow_datatable end

//complain table show
function complainTable() {
  let data = [];
  let { from, to } = __date_range ?? {};
  data["url"] = $("#complain_table_url").val();
  data["value"] = {
    from: from ? from : null,
    to: to ? to : null,
    limit: $("#entries").val(),
  ...
  data["column"] = ["id", "title", "description", "date", "response_deadline", "user", "file","action"];

  data["order"] = [[1, "id"]];
  data["table_id"] = "complain_table_class";
  table(data);
}
$(".complain_table_class").length > 0 && complainTable();

//verbal warning table show
function verbalWarningTable() {
  let data = [];
  let { from, to } = __date_range ?? {};
  data["url"] = $("#verbal_warning_table_url").val();
  data["value"] = {
    from: from ? from : null,
    to: to ? to : null,
    limit: $("#entries").val(),
  ...
  data["column"] = ["id", "title", "description", "date", "user", "file", "action"];

  data["order"] = [[1, "id"]];
  data["table_id"] = "verbal_warning_table_class";
  table(data);
}
$(".verbal_warning_table_class").length > 0 && verbalWarningTable();