            ...
            <div class="card-body">
                <form action="{{ $data['url'] }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label class="form-label" for="title">{{ _trans('common.Title') }} <span
                                            class="text-danger">*</span></label>
                                <input type="text" class="form-control ot-form-control ot-input" id="title" name="title" value="{{ $data['edit']->name }}" required>
                                @error('title')
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label class="form-label" for="limit">{{ _trans('common.Limit') }} <span
                                            class="text-danger">*</span></label>
                                <input type="number" min="0" class="form-control ot-form-control ot-input" id="limit" name="limit" value="{{ $data['edit']->limit }}" required>
                                @error('limit')
                                    <div style="color: red;">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select name="limit_type" required
                                    ...
                                    <option value="day" {{ $data['edit']->limit_type == 'day' ? 'selected' : '' }}>
                                        {{ _trans('common.Day') }}</option>
                                    <option value="week" {{ $data['edit']->limit_type == 'week' ? 'selected' : '' }}>
                                        {{ _trans('common.Week') }}</option>
                                    <option value="month" {{ $data['edit']->limit_type == 'month' ? 'selected' : '' }}>
                                        {{ _trans('common.Month') }}</option>
                                    <option value="year" {{ $data['edit']->limit_type == 'year' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label class="form-label" for="max_duration">{{ _trans('common.Max Duration') }} <span
                                            class="text-danger">*</span></label>
                                <input type="number" min="0" class="form-control ot-form-control ot-input" id="max_duration"
                                    name="max_duration" value="{{ $data['edit']->max_duration }}" required>
                                @error('max_duration')
                                    <div style="color: red;">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select name="duration_type" required
                                    ...
                                    <option value="hour" {{ $data['edit']->duration_type == 'hour' ? 'selected' : '' }}>
                                        {{ _trans('common.Hour') }}</option>
                                    <option value="minute" {{ $data['edit']->duration_type == 'minute' ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-check  mt-3">
                                <label class="form-label mt-3 p-2" class="form-check-label" for="is_remark_required">
                                    ...
                                    name="is_remark_required" value="1" {{ $data['edit']->is_remark_required ? 'checked':'' }}>
                                </label>
                            </div>
                        </div>
                    </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label class="form-label" for="description">{{ _trans('common.Description') }} <span
                                            class="text-danger">*</span></label>
                                <textarea class="form-control text-area-height-unset" rows="5" id="description" name="description">{{ $data['edit']->description }}</textarea>
                                @error('description')
                                    <div style="color: red;">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <select name="status_id" required
                                    class="form-select demo-select2-placeholder {{ $errors->has('status_id') ? 'is-invalid' : '' }} select2">
                                    <option value="1" {{ $data['edit']->status_id == '1' ? 'selected' : '' }}>
                                        {{ _trans('common.Active') }}</option>
                                    <option value="4" {{ $data['edit']->status_id == '4' ? 'selected' : '' }}>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label class="form-label" for="description">{{ _trans('common.Icon') }}</label>
